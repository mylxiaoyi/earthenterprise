...
gstTextureGuard gstTextureManager::NewTextureFromPath(
  ...
  bool is_flat_imagery_asset = base.contains(QString::fromStdString(kImageryAssetSuffix));
  bool is_flat_terrain_asset = base.contains(QString::fromStdString(kTerrainAssetSuffix));
  bool is_mercator_imagery_asset = base.contains(QString::fromStdString(kMercatorImageryAssetSuffix));
