...
#ifndef GEO_EARTH_ENTERPRISE_SRC_FUSION_FUSIONUI_PUBLISHDATABASEDIALOG_H_
#define GEO_EARTH_ENTERPRISE_SRC_FUSION_FUSIONUI_PUBLISHDATABASEDIALOG_H_
...
#endif  // GEO_EARTH_ENTERPRISE_SRC_FUSION_FUSIONUI_PUBLISHDATABASEDIALOG_H_
