...
#ifndef KHSRC_FUSION_FUSIONUI_SEARCHTABDETAILS_H__
#define KHSRC_FUSION_FUSIONUI_SEARCHTABDETAILS_H__
...
class SearchTabDetails : public Ui::SearchTabDetailsBase {
 public:
  ...
  const SearchTabReference ref_;
};

#endif  // !KHSRC_FUSION_FUSIONUI_SEARCHTABDETAILS_H__
